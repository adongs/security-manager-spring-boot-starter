...
import com.adongs.annotation.extend.lock.RedisLock;
...
public class RedisLockAspect extends BaseAspect {
    ...
    public Object around(ProceedingJoinPoint joinPoint, RedisLock lock)throws Throwable{
        ...
        Object locks = lockProcessor.lock(key, lock.timeout());
         try {
    ...
    private String buildId(ProceedingJoinPoint joinPoint,RedisLock lock){
