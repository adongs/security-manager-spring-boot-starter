 ...
 * @version 1.0
 */
public class AuthorityAuthenticationFilter extends AbstractSessionFilter{

    private final AuthorityAuthentication authentication;

    public AuthorityAuthenticationFilter(DispatcherServlet dispatcherServlet, ApplicationContext context, AuthorityAuthentication authentication) {
    ...
    public void execution(HttpServletRequest request, HttpServletResponse response) throws Exception {
        authentication.authenticate(request, Terminal.get());
    }
}
